...
# BATCH_SIZE is global across the 8 local TPU devices; the default 512 means
# per-device batch 64.
...
export LR="${LR:-1e-4}"
export MAX_TRAINING_SAMPLES="${MAX_TRAINING_SAMPLES:-5000000000}"
export WARMUP_SAMPLES="${WARMUP_SAMPLES:-32000000}"
export SAVE_EVERY_SAMPLES="${SAVE_EVERY_SAMPLES:-100000000}"
export VAL_EVERY_SAMPLES="${VAL_EVERY_SAMPLES:-100000000}"
