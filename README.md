...
AdamW uses capturable step tensors, and random symmetries/history preprocessing
are applied before transfer to XLA to avoid repeated training-graph compilation.
